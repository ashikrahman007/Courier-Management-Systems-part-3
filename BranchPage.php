...
.full-screen {
  ...
  background-repeat: no-repeat;
    ...
    <body>
        ...
        include 'navBar.php';
         ?>
        <div class="container-fluid" style=" background-image: url(images/bg1.jpg); background-repeat: no-repeat; background-size: cover;">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <div class="col-md-6"><a href="viewAllCouriers.php" >
                    <div class="container" style="width: 300px;  color: #fff;
    background-color:  #83c11f; text-align: center;
    border-color: #83c11f; box-shadow: 0px 0px 10px #000;
    
    ">
                        <span class="fa fa-book" style="  font-size: 50px; padding-top: 10%;"></span>
                    ...
                    <a href="AddStaff.php" >
                    <div class="container" style="width: 300px;color: #fff;
    background-color:  #83c11f; text-align: center; border-color: #83c11f; box-shadow: 0px 0px 10px #000; 
    
    ">
                        <span class="fa fa-male" style="  font-size: 50px; padding-top: 10%;"></span>
                         <h4>Manage Staff</h4>
                    </div>
                    </a>
                    
                    <a href="makeDelivery.php" >
                    <div class="container" style="width: 300px; color: #fff;
    background-color:  #83c11f; text-align: center;
    border-color: #83c11f; box-shadow: 0px 0px 10px #000;
    
    ">
                        <span class="fa fa-map" style="  font-size: 50px; padding-top: 10%;"></span>
                         <h4>Deliver Couriers</h4>
                    </div></a>
                </div>
